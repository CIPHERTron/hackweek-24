...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchScannedData = () => {
      try {
        fetch("https://adoption-maturity.onrender.com/scan-account", {
          method: "post",
          headers: {
        ...
        <main className="grid grid-rows-3 grid-flow-col gap-4 sm:px-6 sm:py-0 md:gap-8">
          ...
          >
            <CardHeader>
              ...
              <CardDescription>for Prodcution deployments</CardDescription>
            </CardHeader>
            ...
            {/* <CardFooter>
              <div className="text-base text-primary">
                Note : Leadership dashboard is generated by scanning prodcution
                pipelines only
              </div>
            </CardFooter> */}
          </Card>
